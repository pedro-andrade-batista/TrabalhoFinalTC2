...
export class APIconnectionService {
  ...
  public addAdmin(admin: Admin): Observable<any>{
    ...
    return this.http.put(`${this.baseURL}administradores.php`, body, {observe: "response"});
  }
  ...
  public login(admin: Admin): Observable<any>{
    ...
    body = body.set("login", admin.email);
    body = body.set("senha", admin.senha);
    return this.http.post(`${this.baseURL}administradores.php`, body, {observe: "response"});
  }
}
